...
// checks if the VideoEmbeddingTask type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VideoEmbeddingTask{}

// VideoEmbeddingTask A video embedding task that describes the status of the task and the metadata about the video. 
type VideoEmbeddingTask struct {
	...
	VideoEmbedding *VideoEmbeddingTaskVideoEmbedding `json:"video_embedding,omitempty"`
}
...
func (o *VideoEmbeddingTask) GetVideoEmbedding() VideoEmbeddingTaskVideoEmbedding {
	if o == nil || IsNil(o.VideoEmbedding) {
		var ret VideoEmbeddingTaskVideoEmbedding
		return ret
	}
...
// SetVideoEmbedding gets a reference to the given VideoEmbeddingTaskVideoEmbedding and assigns it to the VideoEmbedding field.
func (o *VideoEmbeddingTask) SetVideoEmbedding(v VideoEmbeddingTaskVideoEmbedding) {
	o.VideoEmbedding = &v
}

func (o VideoEmbeddingTask) MarshalJSON() ([]byte, error) {
...
func (o VideoEmbeddingTask) ToMap() (map[string]interface{}, error) {
...
type NullableVideoEmbeddingTask struct {
	value *VideoEmbeddingTask
	isSet bool
}

func (v NullableVideoEmbeddingTask) Get() *VideoEmbeddingTask {
	return v.value
}

func (v *NullableVideoEmbeddingTask) Set(val *VideoEmbeddingTask) {
	v.value = val
	v.isSet = true
}

func (v NullableVideoEmbeddingTask) IsSet() bool {
	return v.isSet
}

func (v *NullableVideoEmbeddingTask) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVideoEmbeddingTask(val *VideoEmbeddingTask) *NullableVideoEmbeddingTask {
	return &NullableVideoEmbeddingTask{value: val, isSet: true}
}

func (v NullableVideoEmbeddingTask) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVideoEmbeddingTask) UnmarshalJSON(src []byte) error {
	v.isSet = true
